...
-- | SQL query close to the libpq representation, i.e. the query text with
-- placeholders @$1@, @$2@, ... along with a tuple of their values. In
-- particular, t'RawSQL' () is isomorphic (modulo bottom) to 'T.Text'.
