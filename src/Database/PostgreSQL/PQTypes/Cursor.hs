...
-- | Name of a cursor.
--
-- /Warning:/ the library interpolates the name verbatim into @DECLARE@,
-- @FETCH@ and @CLOSE@ statements, without quoting or escaping. The name must
-- be a valid SQL identifier. If it comes from untrusted input, SQL injection
-- is possible.
