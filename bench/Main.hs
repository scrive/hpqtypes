...
main =
  ...
  where
    -- The benchmark covers the whole encoding pipeline, including
    -- serialization of the 'Encoding' builder into bytes.
    paramBytes :: ToSQL a => a -> Maybe BS.ByteString
    paramBytes v = case toPQParam v of
      PQParam _ payload -> payload

    -- Arrays of every dimensionality have 10000 elements. This keeps their
    -- encoding times comparable.
    ints1 :: [Int32]
    ints1 = [1 .. 10000]
